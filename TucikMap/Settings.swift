...
class Settings {
    static let panSensitivity: Float = 150
    static let rotationSensitivity: Float = 20
    static let twoFingerPanSensitivity: Float = 0.2
    static let pinchSensitivity: Float = 30000
